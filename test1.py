...
classifier = Classifier("Model3/keras_model.h5" , "Model3/labels.txt") # This is used to classify

offset = 20 # Increase the Frame
imgSize = 300

# Show the Image of American Hand Sign
Image_path = "AHS.jpg"
image = cv2.imread(Image_path)

# Resize the image (width, height)
new_size = (500, 300)  # Change as needed
